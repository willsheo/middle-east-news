# Korean Terminology Glossary (용어집)

**Middle East Daily Briefing**

Pinned Korean renderings for recurring terms, so the Korean edition uses identical vocabulary every day. Consult this file when writing the Korean edition; when a new recurring term appears, add it here the same day (and regenerate the PDF). Do not improvise a different rendering for a term that already has a row.
...
## Briefing Structure (고정 구조)

| English | Korean |
|---|---|
| Middle East Daily Briefing | 중동 일일 브리핑 |
| Middle East Weekly Review | 중동 주간 리뷰 |
| Reporting window | 보고 기간 |
...
| Testable indicators | 검증 가능한 지표 |
| Implications by development | 사안별 함의 |
| Exposure snapshot | 익스포저 현황 |
...
| ceasefire / ceasefire collapse | 휴전 / 휴전 붕괴 |
| memorandum of understanding (MOU) | 양해각서(MOU) |
| strike wave / round of strikes | 공습 (제N차 공습) |
| heavy wave of strikes | 대규모 파상 공습 |
| fact check (CENTCOM public rebuttal of claims) | 팩트체크 |
| escalation / de-escalation | 확전 / 긴장 완화 |
| deterrence | 억지력 |
| retaliation | 보복 (공격) |
| tanker / supertanker (VLCC) | 유조선 / 초대형 유조선(VLCC) |
| dark fleet / going dark | 그림자 선단 / AIS 차단 운항 |
| transponder (AIS) | 선박자동식별장치(AIS) |
| transit count / transits per day | 통항량 / 일일 통항 척수 |
...
| English | Korean |
|---|---|
| 20% toll / reimbursement fee | 20% 통행료 / "상환 수수료" |
| ad valorem (tax) | 종가세 (방식) |
| trade and investment deals | 무역·투자 패키지 |
| risk premium | 리스크 프리미엄 |
| policy risk / kinetic risk | 정책 리스크 / 군사적(키네틱) 리스크 |
| coercive signaling | 강압적 신호 |
| settle / close (price) | 종가 |
| term structure | 기간 구조 |
| spare capacity | 여유 생산능력 |
| strategic petroleum reserve | 전략비축유 |
| reserve release | 비축유 방출 |
| naphtha | 나프타 |
| refiner | 정유사 |
...
| landed cost | 도입 단가 |
| import bill | 수입 비용 |
| receivables | 미수금(공사대금 채권) |
| construction backlog | 수주 잔고 |
| reconstruction | 재건 |
| procurement | 조달 |
| Gulf states | 걸프 국가들 |
...
| IMO | 국제해사기구(IMO) |
| IAEA | 국제원자력기구(IAEA) |
| UNCLOS | 유엔해양법협약(UNCLOS) |
| IEA | 국제에너지기구(IEA) |
| OPEC | 석유수출국기구(OPEC) |
| Bank of Korea (BOK) | 한국은행 |
| MOTIE | 산업통상자원부 |
| MOFA (Korea) | 외교부 |
| UN OCHA | 유엔 인도주의업무조정국(OCHA) |
| transitional governing authority | 과도 통치 기구 |

## Place and Proper Names (지명·고유명사)

| English | Korean |
|---|---|
| Pickaxe Mountain (Kuh-e Kolang) | 픽액스 마운틴(쿠헤 콜랑) |
| Bandar Abbas | 반다르아바스 |
| Kish Island | 키시섬 |
| Sirik | 시리크 |
| Omidiyeh | 오미디예 |
| Natanz / Fordow | 나탄즈 / 포르도 |
| Ras Laffan | 라스라판 |
| Jabalia | 자발리아 |
| Rafah | 라파 |
| Barakah nuclear plant | 바라카 원전 |
| Mombasa / Al Bahiyah (tankers) | 몸바사호 / 알바히야호 |
| Mojtaba Khamenei | 모즈타바 하메네이 |
| al-Juffair (Bahrain) | 알주파이르 |
...
| World Central Kitchen (WCK) | 월드 센트럴 키친(WCK) |
| Somali piracy / pirates | 소말리아 해적 |
...
| Multinational Maritime Defense Alliance | 다국적 해상방위동맹 |
| NSC Standing Committee (South Korea) | 국가안전보장회의 상임위원회 |
| day rate (VLCC charter rate) | 일일 용선료 |
